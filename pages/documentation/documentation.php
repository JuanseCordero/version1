              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-12 pt-5">
                    <a class="btn btn-primary" href="../../dashboard.php"><i class="ti-home mr-2"></i>Back to home</a>
                  </div>
                </div>
                <div class="row pt-5 mt-5">
                  <div class="col-12 pt-5 text-center">
                    ...
                    <h3 class="text-primary font-weight-light mt-5">
                      La documentación completa de Studcents se encuentra en: 
                      <a href="#" target="_blank" class="text-danger d-block text-truncate">
                        http://studcents_informacion.com.co
                      </a>
                    </h3>
